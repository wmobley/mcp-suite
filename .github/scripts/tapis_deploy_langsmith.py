"""Deploy or restart the LangSmith MCP Tapis pod after a successful image build.
...
Environment variables set by the workflow:
  ...
  LANGSMITH_API_KEY               — forwarded to pod env
...
if pod_exists:
    ...
    t.pods.create_pod(
        pod_id=pod_id,
        image=image,
        description="DSO LangSmith MCP server (HTTP transport)",
        ...
        networking={"default": {"protocol": "http", "port": 8300}},
    )
